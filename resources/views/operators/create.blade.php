...
@section('title', 'Dodaj operatera - EcoFlow')

@section('content')
    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
        <!-- Header -->
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-900">Dodaj novog operatera</h1>
            <p class="mt-2 text-sm text-gray-600">Popunite formu sa podacima o operateru</p>
        </div>
        ...
        <!-- Form -->
        <form action="{{ route('operators.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    >
                        <option value="aktivan" {{ old('status', 'aktivan') == 'aktivan' ? 'selected' : '' }}>Aktivan</option>
