...
@section('content')
    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
        ...
        <!-- Automation Info -->
        <div class="mx-6 mt-4 p-4 bg-emerald-50 border-l-4 border-emerald-500 rounded-lg">
            <div class="flex">
                <div class="flex-shrink-0">
                ...
                <div class="ml-3">
                    <p class="text-sm text-emerald-800">
                        <strong>Automatizacija aktivna:</strong> Kada dodate, izmenite ili obrišete zapis evidencije otpada, sistem automatski ažurira evidencijone listove (EL) i godišnje izveštaje za odgovarajuću firmu i godinu. 
